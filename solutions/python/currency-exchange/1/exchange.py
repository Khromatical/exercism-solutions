...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    computed_exchange_rate = exchange_rate * (spread / 100) + exchange_rate
    computed_budget = budget / computed_exchange_rate
    computed_value = computed_budget - (computed_budget % denomination)
